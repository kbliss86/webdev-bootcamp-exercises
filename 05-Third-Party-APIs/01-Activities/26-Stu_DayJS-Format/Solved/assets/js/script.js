...
var gradDate = dayjs('2023-11-30').format('MMM D, YYYY');
$('#1a').text(gradDate);
/*
 * Or if you don't need it in a variable you can compute it straight in the jQuery
    $('#1a').text(dayjs('2023-11-30').format('MMM D, YYYY'))
*/
